...
CREATE TABLE TABLE_UNIQUE(LOGIN_ID VARCHAR(20) UNIQUE,
 LOGIN_PWD VARCHAR2(20) NOT NULL,ㄹ
  TEL VARCHAR2(20));
...
-- 중복여부만 확인(NULL을 확인하지는 않음)
INSERT  INTO TABLE_UNIQUE VALUES (NULL,'TEST_PW_01','010-1234-5678');

CREATE TABLE TABLE_UNIQUE2(LOGIN_ID VARCHAR(20) CONSTRAINT TBLUNQ2_LGN_UNQ UNIQUE,
...
CREATE TABLE TABLE_PK(LOGIN_ID VARCHAR(20) PRIMARY KEY,
 LOGIN_PWD VARCHAR2(20) NOT NULL,
  TEL VARCHAR2(20)
 );
...
CREATE TABLE TABLE_CHECK(
 LOGIN_ID VARCHAR2(20) PRIMARY KEY ,
  LOGIN_PWD VARCHAR2(20) CONSTRAINT TBLCK_LHNPW_CK CHECK (LENGTH(LOGIN_PWD) >= 3) , -- 길이가 3이상
  TEL VARCHAR2(20)
);

--체크 제약조건(SCOTT.TBLCK_LHNPW_CK)이 위배되었습니다
...
-- BOARD 테이블 정의
-- BNO(숫자), NAME,PASSWORD,TITLE,CONTENT,READACT(숫자), REGDATE(날짜 - DEFAULT 현재시스템 날짜)
-- 기본키 : BNO,
...
DELETE FROM BOARD 
INSERT INTO BOARD(BNO, NAME,PASSWORD,TITLE,CONTENT) VALUES(BOARD_SEQ.NEXTVAL,'박현서','123456','게시판','게시글작성')
